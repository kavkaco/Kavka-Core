...
import (
	...
	context "context"
	errors "errors"
	message "github.com/kavkaco/Kavka-Core/protobuf/gen/go/protobuf/message"
	http "net/http"
	strings "strings"
)
...
func NewMessageServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MessageServiceClient {
	...
	return &messageServiceClient{
		fetchMessages: connect.NewClient[message.FetchMessagesRequest, message.FetchMessagesResponse](
			httpClient,
...
func (c *messageServiceClient) FetchMessages(ctx context.Context, req *connect.Request[message.FetchMessagesRequest]) (*connect.Response[message.FetchMessagesResponse], error) {
